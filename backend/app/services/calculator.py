"""Core calculation logic for KYPA household impact."""
...
from kypa_calc.household import build_household_situation
from kypa_calc.reforms import create_kypa_reform
...
async def calculate_household_impact(
    ...
    """
    Calculate KYPA impact across income range for a household.
    ...
    reform = create_kypa_reform(year=year)
