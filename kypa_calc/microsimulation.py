...
def calculate_aggregate_impact(year: int = 2026) -> dict:
    """
    Calculate aggregate impact of the Keep Your Pay Act for a given year.

    Args:
        year: Tax year (2026-2035).

    Returns:
        Dict with budget, decile, intra_decile, poverty, and income bracket data.
    """
